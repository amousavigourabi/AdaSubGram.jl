...
function initialize(vector_dims::Int64, input_words::Int64, word_counts::Vector{Int64}, input_subwords::Int64, senses::Int64, tree_nodes::Int64, alpha::Float32)
  ...
  as[:, 1] += word_counts
  bs = fill(alpha, input_words, senses)
  model = Parameters(in_subwords, in_senses, out, as, bs)
  return model
end

function forward_pass(model::Parameters, input_word::Int64, input_subwords::Vector{Int64})::Tuple{Array{Float32, 2}, Array{Float32, 2}}
