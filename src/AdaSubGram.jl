...
function settings(dims::Int64=300, senses::Int64=10, context::Int64=8, α::Float32=0.15f0, epochs::Int64=3, s_min::Int64=4, s_max::Int64=7, subword_truncation::Int64=1_000_000, η_1::Float32=0.025f0, η_2::Float32=NaN32, cutoff::Float32=0.01f0)
...
function create_encodings(input::Filepath, output::Filepath, settings::Settings)
  ...
  final_loss = AdaSubGram.Model.train(model, dataset, nodes_decisions, train_settings, max_nodes, settings.cutoff)
